...
const Portfolio = () => {
    return (
        <div className='relative h-screen bg-gradient-to-b from-gray-900/10 to-[#010511] lg:h-[0vh] '>
            <Head>
                <title>Portfolio Site - Amyol</title>
            ...
            <motion.div exit={{ opacity: 0 }} initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{duration:1}} className='bg-[#282828] flex flex-col items-center justify-center pt-[130px] pb-[60px] '>
                ...
                <div className='pt-5'>
                    <img src="/image/works/work1.png" className='w-[300px] rounded-2xl border-4 ' alt="" />
                </div>
                
                <div className='p-2 text-sm  text-white'><span className='text-red-400 hover:text-red-500'><Link href="/works"><a>Works</a></Link></span> -{'>'} Portfolio Site</div>
                ...
                <div className=' text-white'>
                    ...
                    ㅤㅤReactJS, StyledComponents, ThreeJS
                </div>
                <div className='pt-5'>
